...
public class GeminiPredictionService {
    ...
    public String constructAstrologicalPrompt(PredictionRequestDTO req) {
        ...
        sb.append("=== GENERATION DIRECTIVES ===\n")
          ...
          .append("   - For EACH year, you MUST provide 'yearlyTheme', 'detailedPrediction' (a rich, multi-dimensional, deeply articulated narrative paragraph synthesizing that specific year's real-life events: career moves/job changes/promotions/setbacks, wealth/property/debts/investments, physical vitality/organ health/surgeries, family/marriage/domestic harmony, children's milestones, parental health decline or bereavement if indicated by D12/D30 & 8th/12th/Maraka dasas, and psychological mindset with unbroken lifespan continuity — do NOT leave out any life domains), 'astrologicalBasis' (explicit planetary combination from D1/D9/D10/D12/D30 & running Dasa-Bhukthi), and 'cautionsAndRemedies'.\n\n")
